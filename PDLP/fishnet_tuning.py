...
if __name__ == '__main__':
    ...
    #  Now, we search through each parameter combination for fishnet
    #  i = 4,5,6,7,8,9  exponent of points
    #  k = 32, 64, 128, 256, 512, 1024  number of PDHG iterations in fishnet
    i_list = [4,5,6,7,8,9]
    k_list = [32,64,128,256,512,1024]
    for i in i_list:
        for k in k_list:
            #  Run solver with these parameters
            for mps_file in mps_files:
                ...
                try:
                    ...
                    if args.fishnet:
                        ...
                        K, c, q, l, u, m_ineq, k, i,  # your choice of hyperparameters
                        device=device
                    )
